...
#ifndef DRONE_CONTROLLER_RSB_NODE_H_
#define DRONE_CONTROLLER_RSB_NODE_H_
...
namespace drone_controller{
	class RsbNode{
	public:
		RsbNode(const ros::NodeHandle& nh, const ros::NodeHandle& private_nh);
		~RsbNode();
	...
	private:
		...
		RsbController position_controller_;
