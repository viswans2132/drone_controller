...
#ifndef DRONE_CONTROLLER_EC_NODE_H_
#define DRONE_CONTROLLER_EC_NODE_H_
...
namespace drone_controller{
	class EcNode{
	public:
		EcNode(const ros::NodeHandle& nh, const ros::NodeHandle& private_nh);
		~EcNode();
	...
	private:
		...
		EcController position_controller_;
