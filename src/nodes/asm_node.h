...
#ifndef DRONE_CONTROLLER_ASM_NODE_H_
#define DRONE_CONTROLLER_ASM_NODE_H_
...
namespace drone_controller{
	class AsmNode{
	public:
		AsmNode(const ros::NodeHandle& nh, const ros::NodeHandle& private_nh);
		~AsmNode();
	...
	private:
		...
		AsmController position_controller_;
