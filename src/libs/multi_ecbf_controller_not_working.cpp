...
namespace drone_controller{
	...
	void MultiEcbfController::ComputeDesiredForces(Eigen::VectorXd* forces) const{
	    ...
	    double he_12 = (ep_12[0]*ep_12[0] + ep_12[1]*ep_12[1])/Kh_ae_ + (ep_12[2]*ep_12[2])/Kh_be_ - 4*Kh_ell_*Kh_ell_;
	    double he_21 = (ep_21[0]*ep_21[0] + ep_21[1]*ep_21[1])/Kh_ae_ + (ep_21[2]*ep_21[2])/Kh_be_ - 4*Kh_ell_*Kh_ell_;
	    ...
	    double dot_x2y2_sqrt_01 = (1-x2y2_sqrt_01)*std::exp(-x2y2_sqrt_01)*(com_odom_01.velocity[0]*position_error_01[0] 
	    						+ com_odom_01.velocity[1]*position_error_01[1])/x2y2_sqrt_01;
	    double dot_x2y2_sqrt_02 = (1-x2y2_sqrt_02)*std::exp(-x2y2_sqrt_02)*(com_odom_02.velocity[0]*position_error_02[0] 
	    						+ com_odom_02.velocity[1]*position_error_02[1])/x2y2_sqrt_02;
	    ...
	    lowerBound << -Khl_b_*hl_01 + dot_x2y2_sqrt_01, -Khl_b_*hl_02 + dot_x2y2_sqrt_02, -Khs_b_*hs_12, -Khe_b_*he_12 , -Khe_b_*he_21 ;
		...
		*forces = - (-velocity_ref).cwiseProduct(appended_Kv_p_)
		...
		static bool landing_03 = false;
		static bool landing_04 = false;


		if(landing_01 || ((position_error_abs_01[0] < 0.03) && (position_error_abs_01[1] < 0.03) && (position_error_abs_01[2] < 0.08))){
			forces[0][0] = 0.0;
			forces[0][1] = 0.0;
			forces[0][2] = 0.0;
			landing_01 = true;
		}
		if(landing_02 || ((position_error_abs_02[0] < 0.03) && (position_error_abs_02[1] < 0.03) && (position_error_abs_02[2] < 0.08))){
			forces[0][3] = 0.0;
			forces[0][4] = 0.0;
			forces[0][5] = 0.0;
			landing_02 = true;
		}
		if(landing_03 || ((position_error_abs_01[0] < 0.03) && (position_error_abs_01[1] < 0.03) && (position_error_abs_01[2] < 0.08))){
			forces[0][0] = 0.0;
			forces[0][1] = 0.0;
			forces[0][2] = 0.0;
			landing_01 = true;
		}
		if(landing_04 || ((position_error_abs_02[0] < 0.03) && (position_error_abs_02[1] < 0.03) && (position_error_abs_02[2] < 0.08))){
			forces[0][3] = 0.0;
			forces[0][4] = 0.0;
			forces[0][5] = 0.0;
			landing_02 = true;
