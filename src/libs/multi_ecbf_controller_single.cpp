...
namespace drone_controller{
	...
	void MultiEcbfController::ComputeDesiredForces(Eigen::VectorXd* forces) const{
	    ...
	    Eigen::SparseMatrix<c_float> A_s(2,6);
	    ...
	    Eigen::Matrix<c_float, 2, 1> lowerBound;
	    lowerBound << -Khl_b_*hl_01 + dot_x2y2_sqrt_01, -Khl_b_*hl_02 + dot_x2y2_sqrt_02;

	    Eigen::Matrix<c_float, 2, 1> upperBound;
	    upperBound << 50, 50;
		...
		*forces = - (-velocity_ref).cwiseProduct(appended_Kv_p_)
		...
		if(landing_01 || ((position_error_abs_01[0] < 0.04) && (position_error_abs_01[1] < 0.04) && (position_error_abs_01[2] < 0.08))){
			forces[0][0] = 0.0;
			forces[0][1] = 0.0;
			forces[0][2] = 0.0;
			// landing_01 = true;
		}
		if(landing_02 || ((position_error_abs_02[0] < 0.04) && (position_error_abs_02[1] < 0.04) && (position_error_abs_02[2] < 0.08))){
			forces[0][3] = 0.0;
			forces[0][4] = 0.0;
			forces[0][5] = 0.0;
			// landing_02 = true;
